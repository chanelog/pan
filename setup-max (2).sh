...
#   Bin     : https://github.com/chanelog/bin
#   v1.8    : Domain WAJIB + SSL acme.sh + semua bin dari chanelog/bin
# ════════════════════════════════════════════════════════════
#
#   Protokol terinstall:
...
# URLs binary — semua dari chanelog/bin
...
show_box_ssh() {
    ...
    printf  "  ${A1}│${NC} 🔒 ${DIM}SSL/Stun.${NC}: ${Y}445 (→DB), 777 (→SSH)${NC}\n"
...
# ── Payload SSH WS — dipanggil dari show_box_ssh ────────────────
_show_ssh_payload() {
    local u="$1" p="$2" ip="$3" dom="$4"

    # Payload untuk HTTP Injector / HTTP Custom style
    # Format: GET / HTTP/1.1[crlf]Host: [host][crlf]Upgrade: websocket[crlf][crlf]
    local PAYLOAD_WS="GET / HTTP/1.1[crlf]Host: ${dom}[crlf]Upgrade: websocket[crlf]Connection: Upgrade[crlf][crlf]"
    local PAYLOAD_PROXY="CONNECT [host_port] HTTP/1.1[crlf]Host: ${dom}[crlf][crlf]"
    local PAYLOAD_SSL="GET wss://${dom}:443/ws-ssh HTTP/1.1[crlf]Host: ${dom}[crlf]Upgrade: websocket[crlf][crlf]"
    ...
    # ── 1. HTTP Injector / HTTP Custom ─────────────────────────────
    echo -e "  ${Y}▸ Payload 1 — HTTP Injector / HTTP Custom (WS HTTP 80)${NC}"
    echo -e "  ${A1}┌──────────────────────────────────────────${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Server   :${NC} ${W}${dom}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port     :${NC} ${Y}80${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Username :${NC} ${W}${u}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Password :${NC} ${W}${p}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Payload  :${NC}"
    echo -e "  ${A1}│${NC}   ${LG}GET / HTTP/1.1[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Host: ${dom}[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Upgrade: websocket[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Connection: Upgrade[crlf][crlf]${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Path WS  :${NC} ${Y}/ws-ssh${NC}"
    echo -e "  ${A1}└──────────────────────────────────────────${NC}"
    echo ""

    # ── 2. WS over TLS (HTTPS 443) ─────────────────────────────────
    echo -e "  ${Y}▸ Payload 2 — WS TLS / HTTPS (Stunnel / SSL Tunnel port 443)${NC}"
    echo -e "  ${A1}┌──────────────────────────────────────────${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Server   :${NC} ${W}${dom}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port     :${NC} ${Y}443${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Username :${NC} ${W}${u}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Password :${NC} ${W}${p}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}SSL/TLS  :${NC} ${LG}ON${NC} (SNI: ${dom})"
    echo -e "  ${A1}│${NC} ${BLD}Payload  :${NC}"
    echo -e "  ${A1}│${NC}   ${LG}GET / HTTP/1.1[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Host: ${dom}[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Upgrade: websocket[crlf]${NC}"
    ...
    # ── 3. Stunnel / SSL Tunnel (port 445 atau 777) ────────────────
    echo -e "  ${Y}▸ Payload 3 — Stunnel SSL (port 445 → Dropbear / port 777 → SSH)${NC}"
    echo -e "  ${A1}┌──────────────────────────────────────────${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Server   :${NC} ${W}${dom}${NC}  ${DIM}(atau IP: ${ip})${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port     :${NC} ${Y}445${NC}  ${DIM}→ Dropbear 109${NC}"
    echo -e "  ${A1}│${NC} ${BLD}       atau${NC} ${Y}777${NC}  ${DIM}→ SSH 22${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Username :${NC} ${W}${u}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Password :${NC} ${W}${p}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}SSL/TLS  :${NC} ${LG}ON${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Mode     :${NC} ${Y}SSL Tunnel${NC}  ${DIM}(tidak perlu payload)${NC}"
    echo -e "  ${A1}└──────────────────────────────────────────${NC}"
    echo ""

    # ── 4. NLTS (Network Level Tunnel / UDP) ──────────────────────
    echo -e "  ${Y}▸ Payload 4 — NLTS / SlowDNS (DNS Tunnel)${NC}"
    echo -e "  ${A1}┌──────────────────────────────────────────${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Server   :${NC} ${W}${dom}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port DNS :${NC} ${Y}53${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port Srv :${NC} ${Y}5300${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Username :${NC} ${W}${u}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Password :${NC} ${W}${p}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Mode     :${NC} ${Y}DNS over UDP${NC}"
    echo -e "  ${A1}│${NC} ${DIM}(Pastikan NS record domain sudah pointing ke IP ini)${NC}"
    echo -e "  ${A1}└──────────────────────────────────────────${NC}"
    echo ""

    # ── 5. OpenTunnel / KPN Tunnel style ──────────────────────────
    echo -e "  ${Y}▸ Payload 5 — OpenTunnel / KPN Tunnel (HTTP Proxy CONNECT)${NC}"
    echo -e "  ${A1}┌──────────────────────────────────────────${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Server   :${NC} ${W}${dom}${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Port     :${NC} ${Y}80${NC}"
    echo -e "  ${A1}│${NC} ${BLD}Username :${NC} ${W}${u}${NC}"
    ...
    echo -e "  ${A1}│${NC}   ${LG}Host: ${dom}[crlf]${NC}"
    echo -e "  ${A1}│${NC}   ${LG}Upgrade: websocket[crlf][crlf]${NC}"
    echo -e "  ${A1}│${NC} ${BLD}SSH Host :${NC} ${W}${dom}${NC}  ${BLD}Port SSH :${NC} ${Y}22${NC}"
    echo -e "  ${A1}└──────────────────────────────────────────${NC}"
    echo ""
...
# ════════════════════════════════════════════════════════════
#  CONFIG TEMPEL XRAY CLIENT — dipanggil dari vmess/vless/trojan add
# ════════════════════════════════════════════════════════════
_show_xray_config() {
    ...
    echo ""
    echo -e "  ${A4}╔══════════════════════════════════════════════════════════${NC}"
    echo -e "  ${A4}║${NC}  ${BLD}📋 CONFIG TEMPEL XRAY CLIENT — ${proto}${NC}"
    echo -e "  ${A4}╚══════════════════════════════════════════════════════════${NC}"
    echo ""
    ...
    # ─── VMess ───────────────────────────────────────────────────
    VMess)
        echo -e "  ${Y}▸ VMess WS TLS (port 443) — v2rayN / NekoBox / Hiddify${NC}"
        cat <<CFGTLS
{
  "v": "2",
  "ps": "${u}-TLS",
...
CFGTLS
        echo ""
        echo -e "  ${Y}▸ VMess WS HTTP (port 80) — tanpa TLS${NC}"
        cat <<CFGHTTP
{
  "v": "2",
  "ps": "${u}-HTTP",
...
CFGHTTP
        echo ""
        echo -e "  ${Y}▸ Outbound config (v2rayN / Xray-core manual)${NC}"
        cat <<CFGOUT
{
  "outbounds": [{
    "protocol": "vmess",
    "settings": {
      "vnext": [{
        "address": "${dom}",
        "port": 443,
        "users": [{ "id": "${uuid_or_pass}", "alterId": 0, "security": "auto" }]
      }]
    },
    "streamSettings": {
      "network": "ws",
      "security": "tls",
      "tlsSettings": { "serverName": "${dom}", "allowInsecure": false },
      "wsSettings": { "path": "/vmess", "headers": { "Host": "${dom}" } }
    },
    "tag": "proxy"
  }]
}
CFGOUT
    ...
    # ─── VLess ───────────────────────────────────────────────────
    VLess)
        echo -e "  ${Y}▸ VLess WS TLS (port 443)${NC}"
        cat <<CFGVLWS
{
  "outbounds": [{
    "protocol": "vless",
    "settings": {
      "vnext": [{
        "address": "${dom}",
        "port": 443,
        "users": [{ "id": "${uuid_or_pass}", "encryption": "none", "flow": "" }]
      }]
    },
    "streamSettings": {
      "network": "ws",
      "security": "tls",
      "tlsSettings": { "serverName": "${dom}", "allowInsecure": false },
      "wsSettings": { "path": "/vless", "headers": { "Host": "${dom}" } }
    },
    "tag": "proxy"
  }]
}
CFGVLWS
        echo ""
        echo -e "  ${Y}▸ VLess WS HTTP (port 80) — tanpa TLS${NC}"
        cat <<CFGVLHTTP
{
  "outbounds": [{
    "protocol": "vless",
    "settings": {
      "vnext": [{
        "address": "${dom}",
        "port": 80,
        "users": [{ "id": "${uuid_or_pass}", "encryption": "none" }]
      }]
    },
    "streamSettings": {
      "network": "ws",
...
CFGVLHTTP
        echo ""
        echo -e "  ${Y}▸ VLess gRPC TLS (port 443)${NC}"
        cat <<CFGVLGRPC
{
  "outbounds": [{
    "protocol": "vless",
...
CFGVLGRPC
    ...
    # ─── Trojan ──────────────────────────────────────────────────
    Trojan)
        echo -e "  ${Y}▸ Trojan WS TLS (port 443)${NC}"
        cat <<CFGTRWS
{
  "outbounds": [{
    "protocol": "trojan",
    ...
    "streamSettings": {
      ...
      "security": "tls",
      "tlsSettings": { "serverName": "${dom}", "allowInsecure": false },
      "wsSettings": { "path": "/trojan-ws", "headers": { "Host": "${dom}" } }
    },
    "tag": "proxy"
  }]
}
CFGTRWS
        echo ""
        echo -e "  ${Y}▸ Trojan gRPC TLS (port 443)${NC}"
        cat <<CFGTRGRPC
{
  "outbounds": [{
    "protocol": "trojan",
...
CFGTRGRPC
    ...
    echo ""
    echo -e "  ${DIM}💡 Salin config di atas ke v2rayN / NekoBox / Hiddify / Clash${NC}"
    echo -e "  ${DIM}   atau gunakan link share vmess:// / vless:// / trojan:// di atas${NC}"
    echo -e "  ${A4}══════════════════════════════════════════════════════════${NC}"
    echo ""
}
...
# ════════════════════════════════════════════════════════════
#  INSTALLER — Download semua bin dari chanelog/bin (step awal)
#  Dipanggil sebelum install service apapun
# ════════════════════════════════════════════════════════════
install_all_bins() {
    inf "Download semua binary dari ${W}chanelog/bin${NC}..."
    local tmp; tmp=$(mktemp -d)
    local ok_count=0 fail_count=0
    local arch; arch=$(uname -m)

    _dl_bin() {
        local url="$1" dest="$2" min_size="${3:-100000}" label="${4:-$(basename "$dest")}"
        inf "  ↓ $label"
        if dl "$url" "$dest"; then
            chmod +x "$dest"
            if verify_binary "$dest" "$min_size"; then
                ok "    ✓ $label terpasang"
                ok_count=$((ok_count+1))
                return 0
            else
                warn "    ✗ $label ukuran mencurigakan — dihapus"
                rm -f "$dest"
                fail_count=$((fail_count+1))
                return 1
            fi
        else
            warn "    ✗ Gagal download $label"
            fail_count=$((fail_count+1))
            return 1
        fi
    }
    ...
    _dl_zip() {
        local url="$1" zipname="$2" bin_in_zip="$3" dest="$4" min_size="${5:-500000}" label="${6:-$(basename "$dest")}"
        inf "  ↓ $label (zip)"
        if dl "$url" "$tmp/$zipname"; then
            unzip -qo "$tmp/$zipname" -d "$tmp/${zipname%.zip}" 2>/dev/null
            local found; found=$(find "$tmp/${zipname%.zip}" -type f -name "$bin_in_zip" 2>/dev/null | head -1)
            if [[ -n "$found" ]] && verify_binary "$found" "$min_size"; then
                install -m755 "$found" "$dest"
                ok "    ✓ $label terpasang"
                ok_count=$((ok_count+1))
                return 0
            else
                warn "    ✗ $label: binary tidak ditemukan atau rusak di zip"
                fail_count=$((fail_count+1))
                return 1
            fi
        else
            warn "    ✗ Gagal download zip $label"
            fail_count=$((fail_count+1))
            return 1
        fi
    }
    ...
    echo ""
    echo -e "  ${A4}◈ Download binary dari: ${W}${BIN_REPO}${NC}"
    echo -e "  ${A1}${_DASH}${NC}"

    # ── 1. Xray (arsitektur aware) ────────────────────────────
    if [[ ! -x "$XRAY_BIN" ]]; then
        case "$arch" in
            aarch64|arm64)
                _dl_zip "$XRAY_URL_ARM" "Xray-linux-arm64-v8a.zip" "xray" "$XRAY_BIN" 1000000 "Xray (arm64)"
                ;;
            *)
    ...
    if [[ ! -x "$TROJANGO_BIN" ]]; then
        ...
        ok "  ✓ Trojan-Go sudah ada — skip"
    fi

    # ── 3. OHP Server ─────────────────────────────────────────
    if [[ ! -x "$OHP_BIN" ]]; then
        _dl_bin "$OHP_URL" "$OHP_BIN" 100000 "OHP Server"
    else
        ok "  ✓ OHP sudah ada — skip"
    fi

    # ── 4. jq (JSON tool, dipakai panel) ─────────────────────
    if ! command -v jq &>/dev/null; then
        _dl_bin "$JQ_URL" "/usr/local/bin/jq" 500000 "jq (JSON tool)"
    else
        ok "  ✓ jq sudah ada — skip"
    fi

    # ── 5. BadVPN (badvpn-master.zip) ────────────────────────
    if [[ ! -x "$UDPGW_BIN" ]]; then
        inf "  ↓ BadVPN UDPGW (zip)"
        if dl "$UDPGW_URL" "$tmp/badvpn-master.zip"; then
            unzip -qo "$tmp/badvpn-master.zip" -d "$tmp/badvpn" 2>/dev/null
            # Cari binary pre-compiled
            local udpgw_bin
            udpgw_bin=$(find "$tmp/badvpn" -type f \( -name "badvpn-udpgw" -o -name "udpgw" \) 2>/dev/null | head -1)
            if [[ -n "$udpgw_bin" ]] && verify_binary "$udpgw_bin" 10000; then
                install -m755 "$udpgw_bin" "$UDPGW_BIN"
                ok "    ✓ BadVPN UDPGW terpasang (binary)"
                ok_count=$((ok_count+1))
            elif command -v cmake &>/dev/null; then
                # Kompile dari source
                local src_dir; src_dir=$(find "$tmp/badvpn" -name "CMakeLists.txt" -maxdepth 3 | head -1 | xargs dirname 2>/dev/null)
                if [[ -n "$src_dir" ]]; then
                    inf "    Kompile badvpn dari source (cmake)..."
                    mkdir -p "$src_dir/build"
                    (cd "$src_dir/build" && cmake ..                         -DBUILD_NOTHING_BY_DEFAULT=1 -DBUILD_UDPGW=1 &>/dev/null                         && make -j2 &>/dev/null) || true
                    local compiled; compiled="$src_dir/build/udpgw/badvpn-udpgw"
                    if [[ -f "$compiled" ]]; then
                        install -m755 "$compiled" "$UDPGW_BIN"
                        ok "    ✓ BadVPN UDPGW dikompile & terpasang"
                        ok_count=$((ok_count+1))
                    else
                        warn "    ✗ Kompile badvpn gagal"
                        fail_count=$((fail_count+1))
                    fi
                else
                    warn "    ✗ CMakeLists.txt tidak ditemukan"
                    fail_count=$((fail_count+1))
                fi
            else
                warn "    ✗ cmake tidak tersedia, install dulu: apt install cmake -y"
                fail_count=$((fail_count+1))
            fi
        else
            warn "    ✗ Gagal download badvpn-master.zip"
            fail_count=$((fail_count+1))
        fi
    else
        ok "  ✓ BadVPN UDPGW sudah ada — skip"
    fi

    # ── 5b. Dropbear (dari chanelog/bin) ────────────────────────
    if ! command -v dropbear &>/dev/null; then
        inf "  ↓ Dropbear (dropbear-master.zip)"
        local db_chk; db_chk=$(mktemp)
        if dl "$DROPBEAR_URL" "$db_chk"; then
            ok "    ✓ dropbear-master.zip berhasil didownload (akan dikompile di step install_ssh)"
            ok_count=$((ok_count+1))
        else
            warn "    ✗ Gagal download dropbear-master.zip"
            fail_count=$((fail_count+1))
        fi
        rm -f "$db_chk"
    else
        ok "  ✓ Dropbear sudah ada — skip"
    fi

    # ── 5c. Stunnel (dari chanelog/bin) ─────────────────────────
    if ! command -v stunnel4 &>/dev/null && ! command -v stunnel &>/dev/null; then
        inf "  ↓ Stunnel (stunnel-master.zip)"
        local st_chk; st_chk=$(mktemp)
        if dl "$STUNNEL_URL" "$st_chk"; then
            ok "    ✓ stunnel-master.zip berhasil didownload (akan dikompile di step install_ssh)"
            ok_count=$((ok_count+1))
        else
            warn "    ✗ Gagal download stunnel-master.zip"
            fail_count=$((fail_count+1))
        fi
        rm -f "$st_chk"
    else
        ok "  ✓ Stunnel sudah ada — skip"
    fi

    # ── 5d. Nginx 1.28.0 (source tar.gz) ───────────────────────
    if ! command -v nginx &>/dev/null || ! nginx -v 2>&1 | grep -q "1\.28"; then
        inf "  ↓ Nginx 1.28.0 (tar.gz source)"
        local nginx_tmp; nginx_tmp=$(mktemp -d)
        if dl "$NGINX_URL" "$nginx_tmp/nginx.tar.gz"; then
            ok "    ✓ nginx-1.28.0.tar.gz berhasil didownload (akan dikompile di step install_nginx)"
            ok_count=$((ok_count+1))
        else
            warn "    ✗ Gagal download nginx dari chanelog/bin — akan fallback ke apt"
            fail_count=$((fail_count+1))
        fi
        rm -rf "$nginx_tmp"
    else
        ok "  ✓ Nginx sudah ada — skip"
    fi

    # ── 5e. WebSocket SSH Proxy (ws_tunnel.py & ws-ssh-server.py) ──
    if [[ ! -f "$WS_DIR/ws-ssh-server.py" ]]; then
        inf "  ↓ WebSocket SSH Proxy (ws_tunnel.py & ws-ssh-server.py)"
        local ws_tmp; ws_tmp=$(mktemp -d)
        if dl "$WS_TUNNEL_URL" "$ws_tmp/ws_tunnel.py" && \
           dl "$WS_SSH_SERVER_URL" "$ws_tmp/ws-ssh-server.py"; then
            ok "    ✓ ws_tunnel.py & ws-ssh-server.py berhasil didownload"
            ok_count=$((ok_count+1))
        else
            warn "    ✗ Gagal download WebSocket SSH proxy"
            fail_count=$((fail_count+1))
        fi
        rm -rf "$ws_tmp"
    else
        ok "  ✓ WebSocket SSH proxy sudah ada — skip"
    fi

    # ── 6. acme.sh (akan dipakai setup_acme_ssl, cek saja) ───
    local ACME_BIN="$HOME/.acme.sh/acme.sh"
    if [[ ! -x "$ACME_BIN" ]]; then
        inf "  ↓ acme.sh"
        local tmp_acme; tmp_acme=$(mktemp)
        if dl "$ACME_URL" "$tmp_acme"; then
            chmod +x "$tmp_acme"
            bash "$tmp_acme" --install --home "$HOME/.acme.sh" --noprofile &>/dev/null
            rm -f "$tmp_acme"
            if [[ -x "$ACME_BIN" ]]; then
                ok "    ✓ acme.sh terpasang"
                ok_count=$((ok_count+1))
            else
                warn "    ✗ acme.sh gagal install"
                fail_count=$((fail_count+1))
            fi
        else
            warn "    ✗ Gagal download acme.sh dari chanelog/bin"
            fail_count=$((fail_count+1))
        fi
    else
        ok "  ✓ acme.sh sudah ada — skip"
    fi

    rm -rf "$tmp"
    echo ""
    echo -e "  ${A1}${_DASH}${NC}"
    echo -e "  ${BLD}Download selesai${NC}: ${LG}${ok_count} berhasil${NC}, ${Y}${fail_count} gagal${NC}"
    echo -e "  ${A1}${_DASH}${NC}"
    [[ "$fail_count" -gt 0 ]] && warn "Binary yang gagal akan dicoba ulang saat install service masing-masing"
    echo ""
}
...
install_ssh() {
    ...
    # ── Dropbear — install dari chanelog/bin ──────────────────────────
    inf "Install Dropbear dari chanelog/bin (port 109, 143)..."
    local db_tmp; db_tmp=$(mktemp -d)
    local db_ok=0

    if dl "$DROPBEAR_URL" "$db_tmp/dropbear-master.zip"; then
        unzip -qo "$db_tmp/dropbear-master.zip" -d "$db_tmp/dropbear" 2>/dev/null

        # Cari binary pre-compiled dropbear & dropbearkey
        local db_bin; db_bin=$(find "$db_tmp/dropbear" -type f -name "dropbear" ! -name "*.c" ! -name "*.h" 2>/dev/null | head -1)
        local dbkey_bin; dbkey_bin=$(find "$db_tmp/dropbear" -type f -name "dropbearkey" ! -name "*.c" 2>/dev/null | head -1)

        if [[ -n "$db_bin" ]] && verify_binary "$db_bin" 100000; then
            install -m755 "$db_bin" /usr/sbin/dropbear
            [[ -n "$dbkey_bin" ]] && install -m755 "$dbkey_bin" /usr/bin/dropbearkey
            ok "Dropbear binary terpasang dari chanelog/bin"
            db_ok=1
        else
            # Compile dari source jika ada Makefile/configure
            local src_dir; src_dir=$(find "$db_tmp/dropbear" -name "configure" -maxdepth 3 | head -1 | xargs dirname 2>/dev/null)
            if [[ -n "$src_dir" ]]; then
                inf "Compile Dropbear dari source..."
                apt-get install -y -qq zlib1g-dev &>/dev/null || true
                (cd "$src_dir" && ./configure --prefix=/usr --disable-zlib &>/dev/null \
                    && make -j"$(nproc)" PROGRAMS="dropbear dropbearkey" &>/dev/null \
                    && make install PROGRAMS="dropbear dropbearkey" &>/dev/null) || true
                if command -v dropbear &>/dev/null; then
                    ok "Dropbear dikompile & terpasang dari chanelog/bin"
                    db_ok=1
                else
                    warn "Compile Dropbear gagal — fallback ke apt"
                fi
            else
                warn "Source Dropbear tidak ditemukan — fallback ke apt"
            fi
        fi
    else
        warn "Gagal download dropbear-master.zip dari chanelog/bin — fallback ke apt"
    fi
    rm -rf "$db_tmp"

    # Fallback apt jika compile/binary gagal
    if [[ "$db_ok" == "0" ]]; then
        apt-get install -y -qq dropbear 2>/dev/null || true
    fi

    # Buat systemd service dropbear jika belum ada (untuk compiled version)
    if [[ ! -f /lib/systemd/system/dropbear.service ]] && \
       [[ ! -f /etc/systemd/system/dropbear.service ]]; then
        cat > /etc/systemd/system/dropbear.service <<'DBSVC'
[Unit]
Description=MAX Panel — Dropbear SSH (chanelog/bin)
After=network.target

[Service]
Type=forking
ExecStart=/usr/sbin/dropbear -p 109 -p 143 -r /etc/dropbear/dropbear_rsa_host_key -r /etc/dropbear/dropbear_dss_host_key -W 65536
...
DBSVC
        ...
        # Update konfigurasi dropbear default (jika pakai /etc/default/dropbear)
    ...
    # ── Stunnel — install dari chanelog/bin, kemudian konfigurasi SSL ──
    inf "Install Stunnel dari chanelog/bin (port 445 → Dropbear:109, 777 → SSH:22)..."
    local st_tmp; st_tmp=$(mktemp -d)
    local st_ok=0

    if dl "$STUNNEL_URL" "$st_tmp/stunnel-master.zip"; then
        unzip -qo "$st_tmp/stunnel-master.zip" -d "$st_tmp/stunnel" 2>/dev/null

        # Cari binary pre-compiled stunnel
        ...
        if [[ -n "$st_bin" ]] && verify_binary "$st_bin" 100000; then
            ...
            ok "Stunnel binary terpasang dari chanelog/bin"
            st_ok=1
        else
            # Compile dari source
            local st_src; st_src=$(find "$st_tmp/stunnel" -name "configure" -maxdepth 4 | head -1 | xargs dirname 2>/dev/null)
            if [[ -n "$st_src" ]]; then
                inf "Compile Stunnel dari source..."
                apt-get install -y -qq libssl-dev &>/dev/null || true
                (cd "$st_src" && ./configure --prefix=/usr --sysconfdir=/etc &>/dev/null \
                    && make -j"$(nproc)" &>/dev/null \
                    && make install &>/dev/null) || true
                if command -v stunnel4 &>/dev/null || command -v stunnel &>/dev/null; then
                    # Pastikan stunnel4 symlink ada
                    command -v stunnel4 &>/dev/null || ln -sf "$(command -v stunnel)" /usr/bin/stunnel4
                    ok "Stunnel dikompile & terpasang dari chanelog/bin"
                    st_ok=1
                else
                    warn "Compile Stunnel gagal — fallback ke apt"
                fi
            else
                warn "Source Stunnel tidak ditemukan — fallback ke apt"
            fi
        fi
    else
        warn "Gagal download stunnel-master.zip dari chanelog/bin — fallback ke apt"
    fi
    rm -rf "$st_tmp"

    # Fallback apt
    if [[ "$st_ok" == "0" ]]; then
        apt-get install -y -qq stunnel4 2>/dev/null || true
    fi

    # Buat user stunnel4 jika belum ada (dibutuhkan untuk chown /var/run)
    id stunnel4 &>/dev/null || useradd -r -s /bin/false stunnel4 2>/dev/null || true

    # Pakai SSL acme.sh (domain terverif) jika ada, fallback xray cert, lalu self-signed
    mkdir -p /etc/stunnel /var/run/stunnel4
    chown stunnel4:stunnel4 /var/run/stunnel4 2>/dev/null || true

    local dom; dom=$(get_domain)
    local acme_key="/etc/ssl/maxpanel/${dom}/key.pem"
    local acme_crt="/etc/ssl/maxpanel/${dom}/fullchain.pem"

    if [[ -s "$acme_key" && -s "$acme_crt" ]]; then
        cat "$acme_key" "$acme_crt" > /etc/stunnel/stunnel.pem
        chmod 600 /etc/stunnel/stunnel.pem
        ok "Stunnel: memakai SSL acme.sh/Let's Encrypt (domain: ${dom})"
    elif [[ -s /etc/xray/xray.key && -s /etc/xray/xray.crt ]]; then
        cat /etc/xray/xray.key /etc/xray/xray.crt > /etc/stunnel/stunnel.pem
        chmod 600 /etc/stunnel/stunnel.pem
        ok "Stunnel: memakai SSL dari /etc/xray/ (shared cert)"
    else
        openssl req -new -newkey rsa:2048 -days 3650 -nodes -x509 \
            -subj "/C=ID/ST=JKT/L=Jakarta/O=MAX/OU=Panel/CN=${dom}" \
        ...
        warn "Stunnel: memakai SSL self-signed (fallback)"
    fi
...
STUN
    ...
    # Buat systemd service stunnel jika compiled dari source (tidak punya service bawaan)
    if [[ ! -f /lib/systemd/system/stunnel4.service ]] && \
       [[ ! -f /etc/systemd/system/stunnel4.service ]]; then
        cat > /etc/systemd/system/stunnel4.service <<'STSVC'
[Unit]
Description=MAX Panel — Stunnel SSL Tunnel (chanelog/bin)
After=network.target

[Service]
Type=forking
PIDFile=/var/run/stunnel4/stunnel.pid
ExecStartPre=/usr/bin/stunnel4 -fd /dev/null 2>/dev/null || true
...
STSVC
        ...
        # Aktifkan stunnel via /etc/default jika pakai apt version
    ...
    ok "Stunnel SSL siap (chanelog/bin): 445 (→DB:109), 777 (→SSH:22)"
}
...
# ════════════════════════════════════════════════════════════
install_xray() {
    inf "Install Xray-core dari chanelog/bin..."
    ...
    if [[ ! -x "$XRAY_BIN" ]] || ! "$XRAY_BIN" version &>/dev/null; then
        ...
        local xray_dl_url
        case "$arch" in
            aarch64|arm64) xray_dl_url="$XRAY_URL_ARM" ;;
            *)             xray_dl_url="$XRAY_URL" ;;
        esac
        inf "Download Xray dari: $xray_dl_url"
        if dl "$xray_dl_url" "$tmp/xray.zip"; then
            ...
            err "Gagal download Xray-core dari $xray_dl_url"
            rm -rf "$tmp"; return 1
        fi
        rm -rf "$tmp"
    else
...
# ════════════════════════════════════════════════════════════
install_trojan_go() {
    inf "Install Trojan-Go dari chanelog/bin..."
    mkdir -p "$TROJANGO_DIR"
    if [[ ! -x "$TROJANGO_BIN" ]]; then
        local tmp; tmp=$(mktemp -d)
        inf "Download Trojan-Go dari: $TROJAN_GO_URL"
        if dl "$TROJAN_GO_URL" "$tmp/trojan-go.zip"; then
            ...
            err "Gagal download Trojan-Go dari $TROJAN_GO_URL"
            rm -rf "$tmp"; return 1
        fi
        rm -rf "$tmp"
    else
...
# ════════════════════════════════════════════════════════════
install_udpgw() {
    inf "Install BadVPN UDPGW dari chanelog/bin..."
    if [[ ! -x "$UDPGW_BIN" ]]; then
        local tmp; tmp=$(mktemp -d)
        inf "Download badvpn dari: $UDPGW_URL"
        if dl "$UDPGW_URL" "$tmp/badvpn-master.zip"; then
            unzip -qo "$tmp/badvpn-master.zip" -d "$tmp" 2>/dev/null
            # Cari binary udpgw di dalam zip (compiled binary atau sumber)
            local udpgw_bin
            udpgw_bin=$(find "$tmp" -type f -name "badvpn-udpgw" 2>/dev/null | head -1)
            if [[ -z "$udpgw_bin" ]]; then
                udpgw_bin=$(find "$tmp" -type f -name "udpgw" 2>/dev/null | head -1)
            fi
            if [[ -n "$udpgw_bin" ]] && verify_binary "$udpgw_bin" 10000; then
                install -m755 "$udpgw_bin" "$UDPGW_BIN"
                ok "BadVPN UDPGW terpasang dari chanelog/bin"
            else
                # Fallback: kompile dari source jika ada CMakeLists.txt
                if command -v cmake &>/dev/null && find "$tmp" -name "CMakeLists.txt" &>/dev/null; then
                    inf "Kompile badvpn dari source..."
                    local srcdir; srcdir=$(find "$tmp" -name "CMakeLists.txt" -maxdepth 3 | head -1 | xargs dirname)
                    mkdir -p "$srcdir/build"
                    cd "$srcdir/build" && cmake .. -DBUILD_NOTHING_BY_DEFAULT=1 \
                        -DBUILD_UDPGW=1 &>/dev/null && make -j2 &>/dev/null
                    if [[ -f "$srcdir/build/udpgw/badvpn-udpgw" ]]; then
                        install -m755 "$srcdir/build/udpgw/badvpn-udpgw" "$UDPGW_BIN"
                        ok "BadVPN UDPGW dikompile & terpasang"
                        cd - &>/dev/null || true
                    else
                        cd - &>/dev/null || true
                        err "Gagal install udpgw dari chanelog/bin"
                        rm -rf "$tmp"; return 1
                    fi
                else
                    err "Binary udpgw tidak ditemukan di zip & cmake tidak tersedia"
                    rm -rf "$tmp"; return 1
                fi
            fi
        else
            err "Gagal download badvpn dari $UDPGW_URL"
            rm -rf "$tmp"; return 1
        fi
        rm -rf "$tmp"
    else
...
install_ws_ssh_proxy() {
    inf "Install WebSocket SSH Proxy dari chanelog/bin..."
    mkdir -p "$WS_DIR"

    # ── Download ws_tunnel.py (module core) ──
    inf "Download ws_tunnel.py dari chanelog/bin..."
    if dl "$WS_TUNNEL_URL" "$WS_DIR/ws_tunnel.py"; then
        chmod +x "$WS_DIR/ws_tunnel.py"
        ok "ws_tunnel.py terpasang"
    else
        warn "Gagal download ws_tunnel.py — akan gunakan fallback"
    fi

    # ── Download ws-ssh-server.py (wrapper) ──
    inf "Download ws-ssh-server.py dari chanelog/bin..."
    if dl "$WS_SSH_SERVER_URL" "$WS_DIR/ws-ssh-server.py"; then
        chmod +x "$WS_DIR/ws-ssh-server.py"
        ok "ws-ssh-server.py terpasang"
    else
        warn "Gagal download ws-ssh-server.py — akan gunakan fallback"
    fi

    # Jika kedua file berhasil, gunakan yang dari chanelog/bin
    if [[ -x "$WS_DIR/ws-ssh-server.py" ]] && [[ -f "$WS_DIR/ws_tunnel.py" ]]; then
        ok "WebSocket SSH proxy siap (dari chanelog/bin)"
        return 0
    fi

    # Fallback: buat ws-proxy minimal inline (original)
    inf "Membuat WebSocket proxy fallback (inline)..."
    cat > "$WS_BIN" <<'WSPY'
#!/usr/bin/env python3
# MAX WS Proxy — HTTP Injector/CONNECT proxy (fallback)
# Forward WebSocket → SSH ke localhost:22
...
class Server(threading.Thread):
    ...
    def run(self):
        ...
        self.sock.listen(5)
        print(f"[*] WS Proxy listening on {self.host}:{self.port}")
        while self.running:
            try:
    ...
    def handle(self, c):
        try:
            req = c.recv(BUFLEN).decode('latin1', errors='ignore')
            if 'GET' in req or 'CONNECT' in req:
                c.sendall(RESPONSE)
                s = socket.create_connection((TARGET_HOST, TARGET_PORT), timeout=10)
                threading.Thread(target=self.relay, args=(c, s, '→'), daemon=True).start()
                self.relay(s, c, '←')
        except: pass
        finally: c.close()
...
if __name__ == '__main__':
    Server(LISTEN_HOST, LISTEN_PORT).run()
    while True: signal.pause()
WSPY
    chmod +x "$WS_BIN"
    ok "WebSocket proxy fallback (inline) siap"

    # ── Buat systemd service untuk ws-ssh-proxy ──
    cat > /etc/systemd/system/ws-ssh-proxy.service <<'WSSVC'
[Unit]
Description=MAX PANEL — WebSocket SSH Proxy (chanelog/bin)
After=network.target
...
Type=simple
User=root
ExecStart=/usr/bin/python3 /opt/maxpanel/ws-ssh-server.py \
...
# ════════════════════════════════════════════════════════════
install_nginx() {
    inf "Install Nginx dari chanelog/bin (nginx-1.28.0.tar.gz) + reverse-proxy..."

    # ── Install Nginx dari chanelog/bin jika belum ada ────────────
    if ! command -v nginx &>/dev/null || ! nginx -v 2>&1 | grep -q "1\.28"; then
        inf "Download nginx-1.28.0.tar.gz dari chanelog/bin..."
        local tmp; tmp=$(mktemp -d)

        # Install build deps untuk compile nginx
        apt-get install -y -qq build-essential libpcre3 libpcre3-dev \
            zlib1g zlib1g-dev libssl-dev libgd-dev \
            libxml2 libxml2-dev libxslt1-dev 2>/dev/null || true
        ...
        if dl "$NGINX_URL" "$tmp/nginx.tar.gz"; then
            ...
            if [[ -n "$src" ]]; then
                inf "Kompile Nginx 1.28.0 dari source..."
                cd "$src"
                ./configure \
                    --prefix=/etc/nginx \
                ...
                if command -v nginx &>/dev/null; then
                    ok "Nginx 1.28.0 berhasil dikompile & terpasang dari chanelog/bin"
                else
                    warn "Kompile nginx gagal — fallback ke apt"
                    apt-get install -y -qq nginx 2>/dev/null || true
                fi
            else
                warn "Source nginx tidak ditemukan di tar — fallback ke apt"
                apt-get install -y -qq nginx 2>/dev/null || true
            fi
        else
            warn "Gagal download nginx dari chanelog/bin — fallback ke apt"
            apt-get install -y -qq nginx 2>/dev/null || true
        fi
        rm -rf "$tmp"

        # Buat direktori cache yang dibutuhkan nginx compiled
        mkdir -p /var/cache/nginx/client_temp \
                 /var/cache/nginx/proxy_temp \
                 /var/cache/nginx/fastcgi_temp \
                 /var/log/nginx

        # Buat systemd service untuk nginx compiled (jika belum ada)
        if [[ ! -f /etc/systemd/system/nginx.service ]] && \
           [[ ! -f /lib/systemd/system/nginx.service ]]; then
            cat > /etc/systemd/system/nginx.service <<'NGSVC'
[Unit]
Description=MAX Panel — Nginx 1.28.0 (chanelog/bin)
After=network.target
...
NGSVC
        ...
        ok "Nginx sudah terpasang — skip download"
    fi
...
# ════════════════════════════════════════════════════════════
install_ohp() {
    inf "Install OHP dari chanelog/bin..."
    if [[ ! -x "$OHP_BIN" ]]; then
        inf "Download OHP dari: $OHP_URL"
        if dl "$OHP_URL" "$OHP_BIN"; then
            ...
            warn "Gagal download OHP dari chanelog/bin — fitur opsional dilewati"
            return
        fi
    fi
...
do_install_all() {
    ...
    # ════════════════════════════════════════════════════════════
    #  INPUT DOMAIN — WAJIB, tidak bisa pakai IP
    # ════════════════════════════════════════════════════════════
    echo ""
    echo -e "  ${A1}${_DASH}${NC}"
    echo -e "  ${A4}◈${NC} ${BLD}${A4}KONFIGURASI AWAL${NC}"
    echo -e "  ${A1}${_DASH}${NC}"
    echo -e "  ${DIM}IP server ini : ${W}${sip}${NC}"
    echo -e "  ${DIM}Pastikan domain sudah pointing (A record) ke IP di atas.${NC}"
    echo -e "  ${A1}${_DASH}${NC}"
    echo ""

    local inp_domain=""
    while true; do
        echo -ne "  ${A3}Domain${NC} (${DIM}wajib, contoh: vpn.example.com${NC}): "
        read -r inp_domain
        inp_domain="${inp_domain// /}"   # strip spasi
        if [[ -z "$inp_domain" ]]; then
            err "Domain WAJIB diisi! Tidak bisa menggunakan IP langsung."
            err "SSL real (acme.sh) hanya bisa diissue untuk domain yang valid."
            echo ""
            continue
        fi
        # Validasi format domain sederhana
        if [[ ! "$inp_domain" =~ ^[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?(\.[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?)+$ ]]; then
            err "Format domain tidak valid: ${inp_domain}"
            err "Gunakan format: sub.domain.tld (contoh: vpn.mysite.com)"
            echo ""
            continue
        fi
        # Cek apakah domain sudah pointing ke IP server
        inf "Memeriksa DNS: ${inp_domain} ..."
        if validate_domain_pointing "$inp_domain"; then
            ok "Domain valid & sudah pointing ke server ini ✓"
            break
        else
            echo ""
            echo -e "  ${Y}⚠${NC}  Domain belum pointing atau DNS belum propagasi."
            echo -ne "  Tetap lanjutkan dengan domain ${W}${inp_domain}${NC}? [y/N]: "
            read -r ans
            if [[ "${ans,,}" == "y" ]]; then
                warn "Lanjut — SSL acme.sh mungkin gagal jika DNS belum propagasi."
                break
            fi
            echo ""
        fi
    ...
    _step  4 "Download & install bin dari chanelog/bin"; install_all_bins
    _step  5 "SSL via acme.sh → domain: $inp_domain"; setup_acme_ssl "$inp_domain" || gen_selfsigned_ssl
    _step  6 "OpenSSH + Dropbear + Stunnel";         install_ssh
    _step  7 "Xray-core (VMess/VLess/Trojan/SS)";    install_xray
    _step  8 "Trojan-Go (port 2087)";                install_trojan_go
    _step  9 "Hysteria 2 (UDP 36712 + range)";       install_hysteria
    _step 10 "BadVPN UDPGW (7100/7200/7300)";        install_udpgw
    _step 11 "OpenVPN (TCP 1194 + UDP 2200)";        install_openvpn
    _step 12 "WireGuard (UDP 51820)";                install_wireguard
    _step 13 "SlowDNS (port 53 + 5300)";             install_slowdns
    _step 14 "WebSocket SSH Proxy (chanelog/bin)";               install_ws_ssh_proxy
...
# ════════════════════════════════════════════════════════════
#  ACME.SH — Install & Issue SSL dari chanelog/bin
#  Dipanggil setelah domain divalidasi
# ════════════════════════════════════════════════════════════
setup_acme_ssl() {
    local domain="$1"
    [[ -z "$domain" ]] && { err "Domain kosong — tidak bisa issue SSL"; return 1; }
    ...
    # ── 1. Install acme.sh dari chanelog/bin ──────────────────
    if [[ ! -x "$ACME_BIN" ]]; then
        inf "Download acme.sh dari chanelog/bin..."
        local tmp_acme; tmp_acme=$(mktemp)
        if ! dl "$ACME_URL" "$tmp_acme"; then
            err "Gagal download acme.sh dari $ACME_URL"
            rm -f "$tmp_acme"; return 1
        fi
        chmod +x "$tmp_acme"
        # Jalankan installer acme.sh (--install tanpa email lebih ringan)
        bash "$tmp_acme" --install --home "$ACME_DIR" --noprofile 2>/dev/null
        rm -f "$tmp_acme"
        if [[ ! -x "$ACME_BIN" ]]; then
            err "acme.sh gagal terinstall"; return 1
        fi
        ok "acme.sh terinstall di $ACME_DIR"
    else
        ok "acme.sh sudah ada — skip install"
    fi

    # ── 2. Set default CA ke Let's Encrypt ──────────────────
    inf "Configure acme.sh → Let's Encrypt CA..."
    "$ACME_BIN" --set-default-ca --server letsencrypt 2>/dev/null

    # ── 3. Issue SSL untuk domain via webroot ──────────────────
    inf "Issue SSL untuk domain: ${W}${domain}${NC} (webroot via Nginx)..."
    mkdir -p /var/www/html/.well-known/acme-challenge

    # Pastikan Nginx running untuk webroot validation
    systemctl start nginx 2>/dev/null
    sleep 2

    # Issue certificate
    "$ACME_BIN" --issue -d "$domain" -w /var/www/html --force 2>&1 |         grep -E "(Cert success|success|error|Domain)" |         while read -r ln; do inf "  $ln"; done

    # ── 4. Cek apakah certificate berhasil ───────────────────
    local issue_ok=0
    local cert_dir
    
    # Cari directory certificate (bisa _ecc atau normal)
    for cert_dir in "$ACME_DIR"/"${domain}"_ecc "$ACME_DIR"/"${domain}"; do
        if [[ -f "$cert_dir"/${domain}.cer ]] || [[ -f "$cert_dir"/${domain}.crt ]]; then
            issue_ok=1
    ...
    if [[ "$issue_ok" == "0" ]]; then
        ...
        err "Penyebab kemungkinan:"
        err "  1. Domain belum pointing ke IP server (${ip})"
        err "  2. Port 80 diblokir firewall/ISP"
        err "  3. DNS belum propagasi (tunggu 5-10 menit)"
        warn "⚠️  Fallback ke self-signed SSL"
        gen_selfsigned_ssl
        return 1
    fi

    ok "✅ SSL issued successfully via Let's Encrypt"

    # ── 5. Copy certificate ke /etc/ssl/maxpanel ──────────────
    inf "Installing certificate to $CERT_DIR..."

    # Copy cert & key
    cp "$ACME_CERT_DIR"/${domain}.cer "$CERT_DIR/cert.pem"
    cp "$ACME_CERT_DIR"/${domain}.key "$CERT_DIR/key.pem"

    # Build fullchain (cert + CA)
    if [[ -f "$ACME_CERT_DIR/fullchain.cer" ]]; then
        cp "$ACME_CERT_DIR/fullchain.cer" "$CERT_DIR/fullchain.pem"
    else
        # Manual concat cert + ca
    ...
    # ── 6. Setup auto-renew via cron ──────────────────────────
    "$ACME_BIN" --install-cert -d "$domain" \
        --cert-file  "$CERT_DIR/cert.pem" \
        --key-file   "$CERT_DIR/key.pem" \
        --fullchain-file "$CERT_DIR/fullchain.pem" \
        --reloadcmd "systemctl reload nginx 2>/dev/null; systemctl reload xray 2>/dev/null" \
        2>/dev/null


    # Symlink / copy ke semua path yang dipakai service
    # — Xray
    mkdir -p /etc/xray
    cp -f "$CERT_DIR/fullchain.pem" /etc/xray/xray.crt
    cp -f "$CERT_DIR/key.pem"       /etc/xray/xray.key
    chmod 644 /etc/xray/xray.crt
    chmod 600 /etc/xray/xray.key

    # — Hysteria
    mkdir -p /etc/hysteria
    cp -f "$CERT_DIR/fullchain.pem" /etc/hysteria/server.crt
    cp -f "$CERT_DIR/key.pem"       /etc/hysteria/server.key
    chmod 644 /etc/hysteria/server.crt
    chmod 600 /etc/hysteria/server.key

    # — Trojan-Go
    mkdir -p /etc/trojan-go
    cp -f "$CERT_DIR/fullchain.pem" /etc/trojan-go/server.crt
    cp -f "$CERT_DIR/key.pem"       /etc/trojan-go/server.key
    chmod 644 /etc/trojan-go/server.crt
    chmod 600 /etc/trojan-go/server.key

    # — Stunnel (butuh format PEM gabungan)
    mkdir -p /etc/stunnel
    cat "$CERT_DIR/key.pem" "$CERT_DIR/fullchain.pem" > /etc/stunnel/stunnel.pem
    chmod 600 /etc/stunnel/stunnel.pem

    # Simpan path cert untuk referensi
    echo "DOMAIN=${domain}" > "$DIR/ssl.conf"
    echo "CERT=${CERT_DIR}/cert.pem" >> "$DIR/ssl.conf"
    echo "KEY=${CERT_DIR}/key.pem" >> "$DIR/ssl.conf"
    echo "FULLCHAIN=${CERT_DIR}/fullchain.pem" >> "$DIR/ssl.conf"

    # Restart semua service yang pakai cert
    systemctl restart stunnel4 2>/dev/null
    systemctl restart xray 2>/dev/null
    systemctl restart trojan-go 2>/dev/null
    systemctl restart hysteria-server 2>/dev/null

    # ── 5. Cronjob auto-renew ──────────────────────────────────
    local renew_hook="cp -f ${CERT_DIR}/fullchain.pem /etc/xray/xray.crt; \
cp -f ${CERT_DIR}/key.pem /etc/xray/xray.key; \
cp -f ${CERT_DIR}/fullchain.pem /etc/hysteria/server.crt; \
cp -f ${CERT_DIR}/key.pem /etc/hysteria/server.key; \
cp -f ${CERT_DIR}/fullchain.pem /etc/trojan-go/server.crt; \
cp -f ${CERT_DIR}/key.pem /etc/trojan-go/server.key; \
cat ${CERT_DIR}/key.pem ${CERT_DIR}/fullchain.pem > /etc/stunnel/stunnel.pem; \
systemctl reload nginx 2>/dev/null; systemctl restart xray 2>/dev/null; \
systemctl restart stunnel4 2>/dev/null; systemctl restart trojan-go 2>/dev/null; \
systemctl restart hysteria-server 2>/dev/null"

    # Hapus cron renew lama jika ada
    sed -i '/acme.*renew.*maxpanel/d' /etc/crontab 2>/dev/null
    # Renew check harian jam 3:00
    ...
    ok "✅ SSL dari acme.sh berhasil! Domain: ${W}${domain}${NC}"
    ok "   Cert : $CERT_DIR/fullchain.pem"
    ok "   Auto-renew : /etc/cron.d/maxpanel-ssl-renew"
    return 0
}

# ── Validasi domain pointing ke IP server ini ───────────────
validate_domain_pointing() {
    local domain="$1"
    local myip; myip=$(get_ip)
    # Resolv domain
    local resolved
    ...
    if [[ "$resolved" == "$myip" ]]; then
        ok "Domain ${W}${domain}${NC} → ${LG}${myip}${NC} ✓ (match)"
        return 0
    else
        warn "Domain ${W}${domain}${NC} resolve ke: ${Y}${resolved:-tidak dikenal}${NC}"
        warn "IP server ini                 : ${Y}${myip}${NC}"
        return 1
    fi
}
